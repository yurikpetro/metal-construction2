...
const DESCRIPTION =
  "Каталог элементов безопасности кровли: ограждения Н600, Н900 и Н1200, трубчатые " +
  "снегозадержатели, кровельные мостики и лестницы. Цены от производителя, " +
  "сертифицированная продукция, доставка по России.";
      ...
      <section className="mt-14 max-w-3xl xl:mt-16">
        ...
        <div className="mt-4 flex flex-col gap-4 text-sm leading-relaxed text-muted-foreground xl:text-base">
          <p>
            ...
            защита при выходе на кровлю. Количество секций считают по длине
            участка, который нужно оградить.
          </p>
          <p>
          ...
          <p>
            ...
            : подберём набор под тип кровли и рассчитаем стоимость с доставкой.
