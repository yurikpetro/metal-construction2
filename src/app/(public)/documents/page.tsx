...
const DESCRIPTION =
  ...
  "на кровельные ограждения, снегозадержатели, мостики и лестницы — скачайте в PDF и DOCX.";
    ...
    <div className="container-narrow py-10 sm:py-14 xl:py-16">
      ...
      <section className="mt-12 xl:mt-14">
        ...
        <div className="mt-3 flex flex-col gap-4 text-sm leading-relaxed text-muted-foreground xl:text-base">
          <p>
            Сертификат соответствия подтверждает, что сварные конструкции —
            снегозадержатели, кровельные ограждения, мостики, кровельные и
            фасадные лестницы — соответствуют требованиям к элементам
            безопасности кровли. Основанием для его выдачи служит протокол
